...
class ActionModule(ActionBase):
    """Cross-platform ping action plugin.

    Abstracts differences between ansible.builtin.ping (Linux/Mac) and
    ansible.windows.win_ping (Windows) by detecting the target OS and
